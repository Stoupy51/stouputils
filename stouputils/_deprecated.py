...
def super_csv_dump(*args: Any, **kwargs: Any) -> Any:
	""" Deprecated function, use :py:func:`~stouputils.io.csv_dump` instead. """
...
def super_csv_load(*args: Any, **kwargs: Any) -> Any:
	""" Deprecated function, use :py:func:`~stouputils.io.csv_load` instead. """
...
def super_json_dump(*args: Any, **kwargs: Any) -> Any:
	""" Deprecated function, use :py:func:`~stouputils.io.json_dump` instead. """
...
def super_json_load(*args: Any, **kwargs: Any) -> Any:
	""" Deprecated function, use :py:func:`~stouputils.io.json_load` instead. """
